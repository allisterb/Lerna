...
namespace Lerna
{
    public abstract class Api
    {
        ...
        static Api()
        {
            ...
            else if (Assembly.GetEntryAssembly().GetName().Name == "Lerna.CLI" && Environment.GetEnvironmentVariable("USERNAME") == "Allister")
            {
                Configuration = new ConfigurationBuilder()
            ...
            else if (Assembly.GetEntryAssembly().GetName().Name == "Lerna.Web" && Environment.GetEnvironmentVariable("USERNAME") == "Allister")
            {
                Configuration = new ConfigurationBuilder()
            ...
            HttpClient.DefaultRequestHeaders.UserAgent.ParseAdd("Lerna/0.1");
        }
