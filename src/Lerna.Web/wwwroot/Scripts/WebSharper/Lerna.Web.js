 ...
 Main.update=function(cui,props,questions,responses,utterances)
 {
  ...
  function addSymptom(s,l,m$1)
  {
   ...
   return Concurrency.Start((b$4=null,Concurrency.Delay(function()
   {
    ...
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.addSymptomJournalEntry:-378697656",[user().Name,s,l,m$1]),function(a$30)
    {
  ...
  function getSymptomJournal(u$1)
  {
   ...
   return Concurrency.Delay(function()
   {
    ...
    return(new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.getSymptomJournal:-113610444",[u$1]);
   });
  }
  ...
  {
   return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.getUser:2060317512",[u]),function(a$30)
   {
    var u$1;
    return a$30==null?(say((function($16)
    {
    ...
    }(Global.id))(u)),ask("addUser",u),Concurrency.Zero()):(u$1=a$30.$0,Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.updateUserLastLogin:444166523",[u$1.Name]),function()
    {
     props.Add("user",u$1);
     ...
     return u$1.LastLoggedIn!=null?Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.humanize:-1738307680",[u$1.LastLoggedIn.$0]),function(a$31)
     {
      say((function($16)
      {
       return function($17)
  ...
  })),null)):m.$==1&&(a$9=NLU.Yes(m.$0),a$9!=null&&a$9.$==1&&(a$10=AnonResponse("addUser",a$9.$0),a$10!=null&&a$10.$==1&&(a$11=Str(a$10.$0[1]),a$11!=null&&a$11.$==1&&(m.$1.$==0&&($4=a$11.$0,true)))))?Concurrency.Start((b$1=null,Concurrency.Delay(function()
  {
   ...
   return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.addUser:444166523",[$4]),function(a$30)
   {
    return a$30==null?(say((function($16)
    {
     return function($17)
  ...
  {
   return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.getUser:2060317512",[$8.get_Value()]),function(a$30)
   {
    return a$30==null?(say((function($16)
    {
     return function($17)
