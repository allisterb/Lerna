...
{
 "use strict";
 var Global,Lerna,Models,Sex,Address,Name,User,Student,StudyJournalEntry,Message,Wit,NLUResponse,Trait,Entity,Web,ClientExtensions,_Html,htmModule,SC$1,Bootstrap,Controls,SC$2,NLU,Intent,Trait$1,Entity$1,Utterance,Question,Voice,_Entity,Text,_Utterance,_Intent,_Entity$1,_Trait,Domain,SC$3,CUI,MicState,ClientState,Interpreter,CUI$1,SC$4,Main,SC$5,Study,SC$6,Client,SC$7,Lerna$Web_GeneratedPrintf,IntelliFactory,Runtime,WebSharper,Strings,Utils,console,$,Arrays,List,Seq,UI,Doc,AttrModule,JavaScript,Pervasives,Collections,Map,NLU$1,Wit$1,WitApi,Concurrency,SDK,Random,Operators,Remoting,AjaxRemotingProvider,QnAMaker,Wit$2,document,Unchecked,Dictionary;
 Global=self;
 ...
 CUI$1=CUI.CUI=Runtime.Class({
  ...
  SayAngry:function(m)
  {
   ...
   {
    var synth;
    synth=ClientExtensions.speechSynthesis();
    return Concurrency.Combine(synth.speaking?(synth.cancel(),SDK.chime(),Concurrency.Zero()):Concurrency.Zero(),Concurrency.Delay(function()
    {
 ...
 Main.update=function(cui,props,questions,responses,utterances)
 {
  ...
  {
   return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.getUser:-342059291",[u]),function(a$32)
   {
    var u$1;
    ...
    }(Global.id))(props.get_Item("user"))),Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.updateUserLastLogin:-711026397",[u$1.Name]),function()
    {
     props.Add("user",u$1);
     return Concurrency.Combine(u$1.LastLoggedIn!=null?Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.humanize:-1868205615",[u$1.LastLoggedIn.$0]),function(a$33)
     {
      say((function($17)
      {
       return function($18)
     ...
     {
      return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.getMessages:-2129773224",[u$1.Name]),function(a$33)
      {
       props.Add("msgs",a$33);
       return a$33!=null&&a$33.$0.get_Length()>0?(say((function($17)
       {
        return function($18)
        {
         return $17("You have "+Global.String($18)+" new messages.");
        };
       }(Global.id))(a$33.$0.get_Length())),say(a$33.$0.get_Item(0).Text),echo((function($17)
       {
        return function($18)
        {
         return $17("Message: "+Utils.toSafe($18));
        };
       }(Global.id))(a$33.$0.get_Item(0).Text)),Concurrency.Zero()):Concurrency.Zero();
      });
     }));
    })));
   });
  })),null)):m.$==1&&(a$9=NLU.Yes(m.$0),a$9!=null&&a$9.$==1&&(a$10=AnonResponse("addUser",a$9.$0),a$10!=null&&a$10.$==1&&(a$11=Str(a$10.$0[1]),a$11!=null&&a$11.$==1&&(m.$1.$==0&&($4=a$11.$0,true)))))?Concurrency.Start((b$1=null,Concurrency.Delay(function()
  {
   ...
   return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.addUser:-711026397",[$4]),function(a$32)
   {
    return a$32==null?(say((function($17)
    {
     return function($18)
    ...
    }(Global.id))($4)),Concurrency.Zero()):(addProp("user",$4),Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.addMessage:1165449348",[$4,"Welcome to Lerna."]),function()
    {
     return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.getMessages:-2129773224",[$4]),function(a$33)
     {
      addProp("msgs",a$33);
      say((function($17)
      {
      ...
      }(Global.id))(a$33.$0.get_Length())),Concurrency.Zero()):Concurrency.Zero();
     });
    }));
   });
  })),null):m.$==1&&(a$12=NLU.No(m.$0),a$12!=null&&a$12.$==1&&(a$13=AnonResponse("addUser",a$12.$0),a$13!=null&&a$13.$==1&&(a$14=Str(a$13.$0[1]),a$14!=null&&a$14.$==1&&(m.$1.$==0&&($5=a$14.$0,true)))))?say((function($17)
  {
   return function($18)
   {
  ...
  {
   return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.getUser:-342059291",[$8.get_Value()]),function(a$32)
   {
    return a$32==null?(say((function($17)
    {
     return function($18)
  ...
  }(Global.id))($10)):m.$==1&&(a$24=Assert(m.$0),a$24!=null&&a$24.$==1&&(($12=NLU.Intent$1("studyjournal",a$24.$0),$12!=null&&$12.$==1)&&m.$1.$==0))?(echo("<img src=\"https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.YSxy_C2rlS83dQdUOq9MqwHaFB%26pid%3DApi&f=1\"/>"),say("Good job! You are right on track with the rest of students in your cohort. Keep it up.")):m.$==1&&(a$25=Assert(m.$0),a$25!=null&&a$25.$==1&&(($14=NLU.Intent$1("nextclass",a$25.$0),$14!=null&&$14.$==1)&&m.$1.$==0))?(echo("<iframe src=\"https://calendar.google.com/calendar/embed?src=cocnrm4290919hobq1f5he7leg%40group.calendar.google.com&ctz=America%2FPort_of_Spain\" style=\"border: 0\" width=\"800\" height=\"600\" frameborder=\"0\" scrolling=\"no\"></iframe>"),say("Your next chemistry class is on Monday at 8:30AM.")):m.$==1&&(a$26=Assert(m.$0),a$26!=null&&a$26.$==1&&(a$27=NLU.Intent$1("reference",a$26.$0),a$27!=null&&a$27.$==1&&(a$28=NLU.Entity1Of1("term",a$27.$0[1]),a$28!=null&&a$28.$==1&&(m.$1.$==0&&($15=a$28.$0,true)))))?Concurrency.Start((b$3=null,Concurrency.Delay(function()
  {
   return Concurrency.Bind(QnAMaker.getAnswer($15.get_Value()),function(a$32)
   {
    var a$33;
    a$33=Arrays.get(a$32.answers,0).answer;
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.mdtohtml:-828694966",[a$33]),function(a$34)
    {
     return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("Lerna.Web:Lerna.Web.Server.mdtotext:-828694966",[a$33]),function(a$35)
     {
      echo(a$34);
      say(a$35);
      return Concurrency.Zero();
  ...
  })),null):m.$==1&&(a$29=Assert(m.$0),a$29!=null&&a$29.$==1&&(a$30=NLU.Intent$1("quiz",a$29.$0),a$30!=null&&a$30.$==1&&(a$31=NLU.Entity1Of1("term",a$30.$0[1]),a$31!=null&&a$31.$==1&&(m.$1.$==0&&($16=a$31.$0,true)))))?Concurrency.Start((b$4=null,Concurrency.Delay(function()
  {
